...
public class Identifier_Usager_Emprunt extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Identifier_Usager_Emprunt frame = new Identifier_Usager_Emprunt();
	...
	public Identifier_Usager_Emprunt() {
		...
		btnSelectionner.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					while(rs.next())
					{
						IHMEmprunt.IdUsagerField.setText(rs.getString("ID"));
						IHMEmprunt.NomUsagerField.setText(rs.getString("Nom"));
